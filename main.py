...
python_course = Course("Python", datetime.now(),
                       datetime.now() + timedelta(days=30))
js_course = Course("JavaScript", datetime.now(),
...
koli_mentor = Mentor("Koli", "Key", date(1987, 3, 13),
                     1200, [python_course, js_course])
